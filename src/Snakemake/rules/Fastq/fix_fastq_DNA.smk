...
if "units" in config:
    _fix_fastq_run_dna_input = lambda wildcards: utils.get_fastq_file(units, wildcards.sample, wildcards.unit, "fq1") if wildcards.read == "read1" else utils.get_fastq_file(units, wildcards.sample, wildcards.unit, "fq2")
