...
if "units" in config:
    import src.lib.python.utils as utils
    _genefuse_input_r1 = lambda wildcards: "fastq/DNA/" + wildcards.sample + "_R1.genefuse.prep.fastq.gz"
    _genefuse_input_r2 = lambda wildcards: "fastq/DNA/" + wildcards.sample + "_R2.genefuse.prep.fastq.gz"
