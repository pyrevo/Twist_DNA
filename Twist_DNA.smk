...
def get_input():
    ...
    input_list.append(["recall/" + s + ".ensemble.vep.exon.soft_filter.vcf.gz" for s in config["DNA_Samples"]])
    input_list.append(["recall/" + s + ".ensemble.vep.exon.soft_filter.ffpe.vcf.gz" for s in config["DNA_Samples"]])
    input_list.append(["recall/" + s + ".ensemble.vep.exon.soft_filter.multibp.vcf" for s in config["DNA_Samples"]])
